    ...
    return(
        <section className="w-screen h-screen absolute top-0 left-0 bg-black/[.6] flex justify-center items-center z-40">
            ...
            <article className="bg-white p-10 w-full h-full  sm:w-1/3 sm:h-fit rounded-xl shadow-md shadow-black relative">
                ...
                <h2 className=" text-blue-950 uppercase text-3xl font-all" >Rules</h2>
                <Image src="/images/icon-close.svg" width={35} height={15} onClick={exit} className="cursor-pointer absolute sm:right-10 sm:top-10 bottom-16 transform translate-x-1/2 right-1/2" alt="exit sign"/>
                </section>
